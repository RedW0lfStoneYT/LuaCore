...
public class PlayerAttributeModifier implements INMSPlayerAttributeModifier {
    ...
    public INMSPlayerAttributeModifier setBlockBreakSpeed(float speed) {
        try {
            Objects.requireNonNull(player.getAttribute(Attribute.PLAYER_BLOCK_BREAK_SPEED)).setBaseValue(speed);
        } catch (NullPointerException ignore) {
        }
        return this;
    }
    ...
    public INMSPlayerAttributeModifier setFallDamageMultiplier(float multiplier) {
        try {
            Objects.requireNonNull(player.getAttribute(Attribute.GENERIC_FALL_DAMAGE_MULTIPLIER)).setBaseValue(multiplier);
        } catch (NullPointerException ignore) {
        }
        return this;
    }
    ...
    public INMSPlayerAttributeModifier setGravity(float gravity) {
        try {
            Objects.requireNonNull(player.getAttribute(Attribute.GENERIC_GRAVITY)).setBaseValue(gravity);
        } catch (NullPointerException ignore) {
        }
        return this;
    }
    ...
    public INMSPlayerAttributeModifier setJumpStrength(float strength) {
        try {
            Objects.requireNonNull(player.getAttribute(Attribute.GENERIC_JUMP_STRENGTH)).setBaseValue(strength);
        } catch (NullPointerException ignore) {
        }
        return this;
    }
    ...
    public INMSPlayerAttributeModifier setBlockInteractionRange(float range) {
        try {
            Objects.requireNonNull(player.getAttribute(Attribute.PLAYER_BLOCK_INTERACTION_RANGE)).setBaseValue(range);
        } catch (NullPointerException ignore) {
        }
        return this;
    }
    ...
    public INMSPlayerAttributeModifier setEntityInteractionRange(float range) {
        try {
            Objects.requireNonNull(player.getAttribute(Attribute.PLAYER_ENTITY_INTERACTION_RANGE)).setBaseValue(range);
        } catch (NullPointerException ignore) {
        }
        return this;
    }
    ...
    public INMSPlayerAttributeModifier setSafeFallDistance(float distance) {
        try {
            Objects.requireNonNull(player.getAttribute(Attribute.GENERIC_SAFE_FALL_DISTANCE)).setBaseValue(distance);
        } catch (NullPointerException ignore) {
        }
        return this;
    }
